...
const MessageTimestamp = createReactClass({
  getDefaultProps() {
...
const DiscordView = createReactClass({
  getDefaultProps() {
    return {
      // TODO: make these two configurable?
      username: 'JotBot',
      avatar_url: 'https://cdn.discordapp.com/attachments/744853637385420924/746281636680695828/jotform-icon-transparent-560x560.png',
